...
import (
	...
	"github.com/lucaslealbr/fclx/chatservice/internal/domain/entity"
	"github.com/lucaslealbr/fclx/chatservice/internal/infra/db"
)
...
func (r *ChatRepositoryMySQL) FindChatByID(ctx context.Context, chatID string) (*entity.Chat, error) {
	...
	messages, err := r.Queries.FindMessagesByChatID(
		ctx,
		chatID,
	)
	...
	erasedMessages, err := r.Queries.FindErasedMessagesByChatID(
		ctx,
		chatID,
	)
